...
class ExperienceProvider with ChangeNotifier {
  ...
  Future<void> addExperience(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$kAppBaseUrl/api/users/experience'),
        headers: {
  ...
  Future<void> updateExperience(BuildContext context, String experienceId,
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse('$kAppBaseUrl/api/users/experience/$experienceId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
